...
export const metadata: Metadata = {
  title: `Лучшие онлайн курсы для детей и подростков в King Code.`,
  description: `"King Code" - онлайн it-школа для детей . Здесь можно изучить математику, программирование и 3D-моделирование с опытными преподавателями.`,
