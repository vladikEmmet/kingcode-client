  ...
  return (
    <section className={styles.section}>
        <div className="container">
            <h2 className="subtitle">Примеры задач, которые встречаются на курсе:</h2>
            <div className={styles.list}>
                <div className={styles["list-item"]}>
                    <h3>Задача для развивающей группы (5-6 лет)</h3>
                ...
                <div className={styles["list-item"]}>
                    <h3>Задача для первой возрастной группы (6-8 лет)</h3>
                ...
                <div className={styles["list-item"]}>
                    <h3>Задача повышенной сложности для второй возрастной группы (8-11 лет)</h3>
                    <div className={styles["list-info"]}>
                ...
                <div className={styles["list-item"]}>
                    <h3>Задача для третьей возрастной группы (11-14 лет)</h3>
                    <div className={styles["list-info"]}>
