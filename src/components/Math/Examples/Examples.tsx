  ...
  return (
    <section className={styles.section}>
        <div className="container">
            <h2 className={montserrat.className}>Примеры задач, которые встречаются на курсе:</h2>
            <div className={styles.list}>
                <div className={styles["list-item"]}>
                    <h3 className={montserrat.className}>Задача для развивающей группы (5-6 лет)</h3>
                ...
                <div className={styles["list-item"]}>
                    <h3 className={montserrat.className}>Задача для первой возрастной группы (6-8 лет)</h3>
                ...
                <div className={styles["list-item"]}>
                    <h3 className={montserrat.className}>Задача повышенной сложности для второй возрастной группы (8-11 лет)</h3>
                    <div className={styles["list-info"]}>
                ...
                <div className={styles["list-item"]}>
                    <h3 className={montserrat.className}>Задача для третьей возрастной группы (11-14 лет)</h3>
                    <div className={styles["list-info"]}>
