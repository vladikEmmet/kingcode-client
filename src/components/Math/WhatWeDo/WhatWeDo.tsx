        ...
        <div className="container">
            <BlackTab className={styles.tab}>
                ...
                <div className={styles.wrapper}>
                    <p className={styles.semi}>Синусы, косинусы, дискриминанты... Вот этого мы проходить не будем. Школьная программа отличается от страны к стране. Знания, которые предлагаем мы, универсальны.</p>
                    <p className={styles.full}>{`Синусы, косинусы, дискриминанты... Вот этого мы проходить не будем. Школьная программа отличается от страны к стране. Знания, которые предлагаем мы, универсальны. Они развивают логику, умение посмотреть на задачу "сверху", навык подбирать необходимый алгоритм.`}</p>
