        ...
        <div className="container">
            ...
            <div className={styles.grid}>
                <BlackTab className={styles["grid-item"]}>
                    ...
                    <p>
                     {"Вы можете создавать игры, в которые залипнут тысячи геймеров. Иногда они будут боготворить Вас как создателя лучшей игры на свете, а иногда будут ненавидеть за слишком сложные уровни (привет миссии с вертолётиком в Vice City)"}
                    </p>
                </BlackTab>
                <BlackTab className={styles["grid-item"]}>
                    <div className={styles.title}>
                ...
                <BlackTab className={styles["grid-item"]}>
                    ...
                    <p>
                        Не бывает дыма без огня, также не бывает Unity без C#. Вы освоите этот язык программирования, что откроет Вам кучу дорог
                    </p>
                </BlackTab>
