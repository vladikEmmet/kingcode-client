        ...
        <div className="container">
            ...
            <div className={styles.list}>
                ...
                <div className={styles["list-item"]}>
                    ...
                    <div className={styles["list-description"]}>
                        {"Инструментами Пикассо и Босха были кисти и холст? Твоими станут монитор и мышь. Твори произведения искусства, попадай на выставки, запускай NFT-коллекции или не запускай, гордо попивая кофе в Starbucks (желательно эстетично с мизинчиком)."}
                    </div>
                </div>
            </div>
        </div>
